import { HostListener, Directive, ElementRef, Injectable, Inject, defineInjectable, inject, Optional, Component, ChangeDetectorRef, InjectionToken, NgZone, ApplicationRef, Injector, EventEmitter, ViewContainerRef, ComponentFactoryResolver, Attribute, SkipSelf, Output, ViewChild, ContentChild, TemplateRef, ChangeDetectionStrategy, IterableDiffers, APP_INITIALIZER, NgModule } from '@angular/core';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import { __awaiter } from 'tslib';
import { DOCUMENT, Location, LocationStrategy, CommonModule } from '@angular/common';
import { NavigationStart, Router, PRIMARY_OUTLET, ActivatedRoute, ChildrenOutletContexts, RouterLink } from '@angular/router';
...
function bindLifecycleEvents(instance, element) {
    /** @type {?} */
    const unregisters = LIFECYCLES.map((/**
     * @param {?} eventName
     * @return {?}
     */
    eventName => {
...
class StackController {
    ...
    setActive(enteringView) {
        ...
        () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield cleanupAsync(enteringView, views, viewsSnapshot);
            return {
                enteringView,
                direction,
                animation,
    ...
    pop(deep, stackId = this.getActiveStackId()) {
        ...
        () => {
            ...
            return this.navCtrl.navigateBack(view.url).then((/**
             * @return {?}
             */
            () => true));
        }));
    ...
    transition(enteringView, leavingView, direction, showGoBack, progressAnimation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (enteringEl && enteringEl !== leavingEl) {
                ...
                yield containerEl.commit(enteringEl, leavingEl, {
                    deepWait: true,
...
class IonRouterOutlet {
     ...
     * @param {?=} parentOutlet
     */
    constructor(parentContexts, location, resolver, name, tabs, changeDetector, config, navCtrl, elementRef, router, zone, activatedRoute, parentOutlet) {
...
class ModalController extends OverlayBaseController {
     ...
     * @param {?} doc
     */
    constructor(angularDelegate, resolver, injector, doc) {
