...
/***/ "./node_modules/@ionic/core/dist/esm/es5/build/chunk-2da9a352.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es5/build/chunk-2da9a352.js ***!
  \***********************************************************************/
...
var CursoService = /** @class */ (function () {
    function CursoService(afs) {
        this.afs = afs;
        this.cursoCollection = this.afs.collection('cursos');
    }
    CursoService.prototype.getCursos = function () {
        return this.cursoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
    ...
    CursoService.prototype.getCurso = function (id) { return this.cursoCollection.doc(id).valueChanges(); };
    CursoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/services/glossario.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/glossario.service.ts ***!
  \***********************************************/
/*! exports provided: GlossarioService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GlossarioService", function() { return GlossarioService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/index.js");
...
var GlossarioService = /** @class */ (function () {
    function GlossarioService(afs) {
        this.afs = afs;
        this.glossarioCollection = this.afs.collection('glossario');
    }
    GlossarioService.prototype.getGlossarios = function () {
        return this.glossarioCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    GlossarioService.prototype.getGlossario = function (id) { return this.glossarioCollection.doc(id).valueChanges(); };
    GlossarioService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])
    ], GlossarioService);
    return GlossarioService;
}());
